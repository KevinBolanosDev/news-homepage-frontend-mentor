  ...
  return (
    <div className='bg-neutral-veryDarkBlue w-[330px] px-6 pt-6 border-2 border-black'>
        ...
        <ul className='text-neutral-offWhite my-4'>
            ...
            <h3 className='font-bold text-base'>Hydrogen VS Electric Cars</h3>
            <p className='text-neutral-darkGrayishBlue text-sm/6 pe-1 my-3 mb-5'>Will hydrogen-fueled cars ever catch up to EVs?</p>
            </li>
            <li className='border-b-2 border-neutral-darkGrayishBlue mb-4 md:mb-6'>
            <h3 className='font-bold text-base'>The Downsides of AI Artistry</h3>
            ...
            <li>
            <h3 className='font-bold text-base'>Is VC Funding Drying Up?</h3>
